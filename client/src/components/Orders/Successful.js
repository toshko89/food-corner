    ...
    <div className="py-5 osahan-coming-soon d-flex justify-content-center align-items-center">
      <div className="col-md-6">
        <div className="text-center pb-3">
          <h1 className="font-weight-bold">{location.state}, your order has been successful</h1>
        </div>
        <div className="bg-white rounded text-center p-4 shadow-sm">
          ...
          <Link to={'/'} className="btn rounded btn-primary btn-lg btn-block">Track My Order</Link>
        </div>
      </div>
    </div>
  )
